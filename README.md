...
Languages:
  ...
  - C# (Branch: [master](https://github.com/KalmeMarq/bso/tree/csharp)) (not up to date)
...
| 0x01 | Byte         | TAG_Byte        | 0x40 - value is unsigned<br>0x51 - value is boolean true<br>0x61 - value is boolean false                                                                                                      | 0 byte                                              | 1 byte                                               |                         |
